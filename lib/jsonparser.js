...
scriptToAddInHtml +="window.event.srcElement.parentElement.getElementsByClassName('traceinfo')[0].style.display = 'block';}";
...
function processJson(jsonData, options){
    ...
    str += "<b>Total tests passed</b>: "+ passCount +" <br/> <b>Total tests failed</b>: "+ failCount +" </div>";
